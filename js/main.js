...
var loadPortfolioSinglePage = function(id, href) {
    ...
    const openInNewTabLinks = document.querySelectorAll('.open-in-new-tab');
...
var animateReveal = function() {
	...
	if ( greveal.length ) {
		...
		greveal.each(function() {
			...
			setTimeout(function() {
				tl
					.fromTo(cover, 1, { skewX: 0 }, { xPercent: 101, transformOrigin: "0% 100%", ease:Expo.easeInOut })
			}, revealNum * 0);
